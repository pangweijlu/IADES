...
p = plot(lvl_low*ones(1, length(tr_date_srl)), ':b', 'LineWidth', 2);
hold on

p = plot(lvl_high*ones(1, length(tr_date_srl)), ':r', 'LineWidth', 2);
hold on
...
ylabel('Rivel Level (meters)', 'FontSize', 20);
xlabel('Observations', 'FontSize', 20);
title('Weisdale Burn, 22-27/02/2015', 'FontSize', 24);
set(gca, 'FontSize', 18);
pause;
